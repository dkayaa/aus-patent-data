...
# Stratified expand: cap any single primary_ipc at 1% of target, then generate only those apps
.venv/bin/python scripts/sample_ipc_apps.py --target 10000 --max-per-symbol-frac 0.01
