...
## Instruction pool
Before pairing patents, build a **cached pool of diverse instruction phrasings** for this task (same idea as abstract/patent drafting):
...
3. Persist under `data/interim/instruction_generation/_pools/legal_reasoning.json`.
