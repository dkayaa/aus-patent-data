...
| Mode | Doc | Scope |
|------|-----|--------|
| Programmatic | [programmatic-validation.md](programmatic-validation.md) | Schema/IPC (WIPO-grounded cosine/ROUGE) + lexical (ROUGE-L / MRC best-span F1) + semantic (Nomic Embed); see `dataset-validation/` |
