...
| Mode | Doc | Scope |
|------|-----|--------|
| Programmatic | [programmatic-validation.md](programmatic-validation.md) | Schema/IPC + lexical (ROUGE-L / MRC best-span F1) + semantic (Nomic Embed cosine on IPC/abstract); see `dataset-validation/` |
